...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def toggle(self):
        ...
        if not self.started:
            ...
            self.five_min = dt.timedelta(minutes=5)
            pg.alert("Это пробная версия приложения, она работает только 5 минут", "Приложение")
            self.calc = self.last  + self.five_min
                ...
                if white.size:
                    ...
                    while found and self.started:
                        ...
                        if now <= self.calc:
                            ...
                            pg.alert("Время бесплатной версии вышло", "Приложение")
                            os._exit(1)
